...
class AwsIamUserTest < Minitest::Test
  ...
  def test_that_MFA_enable_returns_true_if_MFA_Enabled
    ...
    @mock_user_details_provider_factory.expect :create, @mock_user_details_provider, [@mock_user]
    assert AwsIamUser.new(@mock_user, @mock_user_provider, @mock_user_details_provider_factory).has_mfa_enabled?
  end
  ...
  def test_that_MFA_enable_returns_false_if_MFA_is_not_Enabled
    ...
    @mock_user_details_provider_factory.expect :create, @mock_user_details_provider, [@mock_user]
    refute AwsIamUser.new(@mock_user, @mock_user_provider, @mock_user_details_provider_factory).has_mfa_enabled?
  end
  ...
  def test_that_console_Password_returns_true_if_console_Password_has_been_set
    ...
    @mock_user_details_provider_factory.expect :create, @mock_user_details_provider, [@mock_user]
    assert AwsIamUser.new(@mock_user, @mock_user_provider, @mock_user_details_provider_factory).has_console_password?
  end
  ...
  def test_that_console_Password_returns_false_if_console_Password_has_not_been_set
    ...
    @mock_user_details_provider_factory.expect :create, @mock_user_details_provider, [@mock_user]
    refute AwsIamUser.new(@mock_user, @mock_user_provider, @mock_user_details_provider_factory).has_console_password?
  end
  ...
  def test_that_access_keys_returns_aws_iam_access_key_resources
    ...
    assert_equal(stub_access_key_resource,
                 AwsIamUser.new(@mock_user, @mock_user_provider, @mock_user_details_provider_factory, mock_access_key_factory).access_keys[0])
  ...
  def test_to_s
    ...
    @mock_user_details_provider.expect :name, Username
    @mock_user_details_provider_factory.expect :create, @mock_user_details_provider, [test_user]
    expected = "IAM User #{Username}"
    test = AwsIamUser.new({ name: Username }, @mock_user_provider, @mock_user_details_provider_factory).to_s
